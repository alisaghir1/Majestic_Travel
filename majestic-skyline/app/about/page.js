    ...
    <section className="w-full pb-20 pt-60 bg-[#f4f4f9] text-[#1c355e]">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-20 text-center">
          ...
          <p className="text-lg max-w-4xl mx-auto leading-relaxed text-gray-700">
        ...
        <div className="mb-20">
          ...
          <div className="border-t-4 border-[#8b7866] w-48 mx-auto mb-8"></div>
          <p className="text-lg max-w-4xl mx-auto leading-relaxed text-gray-700 text-center">
        ...
        <div className="mb-20">
          ...
          <div className="border-t-4 border-[#8b7866] w-48 mx-auto mb-8"></div>
          <ul className="text-lg max-w-4xl mx-auto list-disc leading-relaxed text-gray-700 space-y-4 px-5">
